...
public class addHelpMap extends Activity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_help_map);
        ...
        // ---------- 위젯 아이디------------------------------------------------------------------
        LinearLayout gotoCurrentLocation = (LinearLayout)findViewById(R.id.currentLayout);
        LinearLayout missionLocation = (LinearLayout)findViewById(R.id.missionLayout);
        LinearLayout meettingLocation = (LinearLayout)findViewById(R.id.mettingLayout);
    ...
    public void preSaveGetData(){
        ...
        if (preMissionLatLng == null){ // 가지고온 값이 없다면. 냅둔다.
            // Toast.makeText(this, "널~", Toast.LENGTH_SHORT).show();
        }else{
    ...
    public void makeMarkDialog(final LatLng latLng){
        ...
        AlertDialog.Builder makeMaker = new AlertDialog.Builder(addHelpMap.this);
        ...
        makeMaker.setNegativeButton("수행지",new DialogInterface.OnClickListener(){
            ...
            public void onClick(DialogInterface dialog, int which) {
                if ( missionLatLng.size() < 5){
                    ...
                    Toast.makeText(addHelpMap.this, "수행지 : "+missionLatLng.size()+" 개 선택.", Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(addHelpMap.this, "수행지는 최대 5개 선택 할 수 있습니다.", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        makeMaker.setPositiveButton("도착지",new DialogInterface.OnClickListener(){
            ...
            public void onClick(DialogInterface dialog, int which) {
                if( existMeettingMark == false){ //마커가 없음 (생성가능)
                    ...
                    existMeettingMark = true;
                    Toast.makeText(addHelpMap.this, "도착지 설정", Toast.LENGTH_SHORT).show();
                }else{ // 이미 마커가있음 ( 생성 불가능 )
                    Toast.makeText(addHelpMap.this, "이미 도착지가 설정되어 있습니다.", Toast.LENGTH_SHORT).show();
                }
            }
        });
...
//                        .defaultMarker(BitmapDescriptorFactory.HUE_YELLOW)));
    ...
    public void noSaveData() {
        android.support.v7.app.AlertDialog.Builder setBack = new android.support.v7.app.AlertDialog.Builder(addHelpMap.this);
